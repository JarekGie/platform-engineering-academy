...
| current_focus | Etap 90 dni — Fundament Kubernetes (teoria: workload controllers) |
| next_action | podcast-first: wejść w moduł `02-modules/kubernetes/` → teoria Deployment vs StatefulSet vs DaemonSet |
| last_checkpoint | 2026-07-12 (onboarding) |
| roadmap_version | 1 |

## Powiązane
[[adaptive-roadmap]], [[current-goal]], [[assessment-baseline]], [[checkpoint-history]],
[[learning-preferences]], `00-start-here/assessments/`.
